			...
			try
			{
				...
				if (rs.next())
				{
					...
					output += "<form method='post' action='items.jsp'> "+
							 "Item code: <input name='itemCode' class='form-control' type='text' value='"+ itemCode +"'><br>" +
							 "Item name: <input name='itemName' class='form-control' type='text' value='"+ itemName +"'><br> "+
							 "Item price: <input name='itemPrice' type='text' class='form-control' value='"+ itemPrice +"'><br> "+
							 "Item description: <input name='itemDesc' class='form-control' type='text' value='"+ itemDesc +"'><br> "+
